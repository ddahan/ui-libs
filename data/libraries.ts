...
export const libraries: Array<Library> = [
  ...
  {
    name: "Maz-UI",
    subName: "Lightweight and efficient library",
    logo: "maz-ui.svg",
    url: "https://louismazel.github.io/maz-ui-3",
    repoOwner: "LouisMazel",
    repoName: "maz-ui",
    package: "maz-ui",
    componentMatchings: [
      "Accordion",
...
export const sortedLibraries = libraries.sort(
  ({ name }, { name: nameb }) => name.toLowerCase() < nameb.toLowerCase() ? -1 : 1
);